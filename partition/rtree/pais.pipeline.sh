...
do
  ...
  do
    ...
    ../genRtreeIndex ${ipath}/${image}.norm.1.dat ${tempPath}/spatial 20 $k $fillFactor
    ...
    ../genPartitionFromIndex  ${tempPath}/spatial > ${opath}/c${k}/${image}.regionmbb.txt 2> ${opath}/c${k}/${image}.idxmbb.gnu
    rc=$?
    if [ $rc -eq 0 ];then
      echo ""
    else
