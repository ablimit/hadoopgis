...
ipath=/home/aaji/proj/data/pais
prog=./str
...
do
  echo "stat:${image}"
  for k in 20   100  200  400 1000 2000 4000 10000 20000 100000 # 0.00001 0.00005 0.0001 0.0002 0.00049 0.00098 0.00197 0.00492 0.00984 0.04922 
  do
