...
do
	...
	then
	    ...
	    cat /dev/shm/mbb.1.txt /dev/shm/mbb.2.txt | python genpid.py ${pardir}/${parid}/${f}.${method}.txt | python reshardPAIS.py ${dir}/algo1/${f}.markup.ablet.1 ${dir}/algo2/${f}.markup.ablet.2 > ${opath}/${method}/${dataset}/${parid}/${f}.markup
