...
double Areas(int cut, struct Branch ba[], int axis, int *cuts);
struct Rect CombineRect(struct Rect *r, struct Rect *rr);

void Partition (struct Branch ba[],  /* branch array */
	int    ff,           /* fill factor */
	struct NodeCut *cc, 
	struct NodeCut *dd)
{
...
{
    int i, j;
    struct Rect rect1, rect2, temprect;
