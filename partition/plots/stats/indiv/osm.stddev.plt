...
# eps
#set terminal postscript eps size 3.5,2.62 enhanced color font 'Helvetica,24' lw 2
set terminal postscript eps size 3.5,2.62 enhanced color font ',28'
set output 'stddevosm.eps'
...
plot 'osm.stddev.dat' using 1:2  notitle with lines ls 3,	\
