...
int InsertRect(int idxp, struct Rect *r, int id, struct Node **root, int level)
{
    int i;
    struct Node *newroot;
    struct Node *newnode; 
...
int InsertRect2(int idxp, struct Rect *r, int id, struct Node *n, struct Node **new, int level)
{
    int i, done, needsdone;
    int RectInNode();
    int Updates, ins;
    struct OverFlowNode *overflow ;
    struct Rect dummy;
 ...
 **
 */
int InsertRect2OFN( int idxp, struct Rect r, struct OverFlowNode *overflow, struct Rect * rect, struct Node **newnode )
{
    int i, j, k, side, ind, count;
    int overlap, left=0, right=0, up=0, down=0;
    struct OverFlowNode *rp, *rq;
    struct Branch b;
