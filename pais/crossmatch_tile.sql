...
-- SELECT count(*) FROM markup_polygon  WHERE  tilename ='gbm1.1-0000040960-0000040960' AND pais_uid = 'gbm1.1_40x_20x_NS-MORPH_1' ;
-- SELECT count(*) FROM markup_polygon  WHERE  tilename ='gbm1.1-0000040960-0000040960' AND pais_uid = 'gbm1.1_40x_20x_NS-MORPH_2' ;

-- single tile 
-- SELECT 'query start time' as time , now() as tick ; 
\timing 
SELECT count(*) FROM (
...
WHERE  A.tilename ='gbm1.1-0000040960-0000040960' AND A.pais_uid = 'gbm1.1_40x_20x_NS-MORPH_1' AND
       B.tilename ='gbm1.1-0000040960-0000040960' AND B.pais_uid = 'gbm1.1_40x_20x_NS-MORPH_2' ) AS temp ;

--SELECT 'query finish time' as time , now() as tick ; 
