...
-- WHERE  A.name =B.name  AND  A.sequencenumber = 1 AND B.sequencenumber = 2 ) AS temp ;
...
WHERE  A.tilename = B.tilename  AND  A.sequencenumber = 1 AND B.sequencenumber = 2 ) AS temp ;
