SELECT  A.pais_uid , A.tilename, ST_Distance(ST_Centroid(A.polygon), ST_Centroid(B.polygon)) AS centroid_distance, ST_Area(ST_Intersection(A.polygon, B.polygon) )/ST_Area(ST_Union( a.polygon, b.polygon)) AS area_ratio 
