...
// area of an mbr
inline int mbr_area(mbr_t *mbr)
{
	return (mbr->r - mbr->l) * (mbr->t - mbr->b);
}

// area of the rectangular covering both mbrs
inline int mbr_area_2(mbr_t *mbr1, mbr_t *mbr2)
{
	int l, r, b, t;
	l = MIN(mbr1->l, mbr2->l);
	r = MAX(mbr1->r, mbr2->r);
...
inline int mbr_area_inc(mbr_t *mbr, mbr_t *mbr_inc)
{
	return mbr_area_2(mbr, mbr_inc) - mbr_area(mbr);
}

// whether two mbrs are the same
inline int mbr_diff(mbr_t *mbr1, mbr_t *mbr2)
{
...
inline int in_mbr(mbr_t *mbr, int x, int y)
{
...
inline int mbr_intersect(mbr_t *mbr1, mbr_t *mbr2)
{
	return	(
...
// updated
inline int mbr_update(mbr_t *mbr, mbr_t *mbr_inc)
{
	int mbr_changed = 0;
...
inline void mbr_merge(mbr_t *merge_to, mbr_t *mbr1, mbr_t *mbr2)
{
...
//extern inline int mbr_area(mbr_t *mbr);
//extern inline int mbr_area_2(mbr_t *mbr1, mbr_t *mbr2);
//extern inline int mbr_area_inc(mbr_t *mbr, mbr_t *mbr_inc);
//extern inline int mbr_diff(mbr_t *mbr1, mbr_t *mbr2);
//extern inline int in_mbr(mbr_t *mbr, int x, int y);
//extern inline int mbr_intersect(mbr_t *mbr1, mbr_t *mbr2);
//extern inline int mbr_update(mbr_t *mbr, mbr_t *mbr_inc);
//extern inline void mbr_merge(mbr_t *merge_to, mbr_t *mbr1, mbr_t *mbr2);
